...
export default class RepositoryExporter extends Exporter {
    constructor() {
        super();
        this.output = 'output/repositories.csv';
    ...
    process_single(data) {
        ...
        this.data = [{
            ...
            'description': data.description ? data.description.replace(/,/g, '<COMMA>') : '',
            'fork': data.fork,
            'url': data.url,
    ...
    getCloneUrl() {
        return this.data[0].clone_url;
    }

    getFullName() {
        return this.data[0].full_name;
    }
